# Graph Report - Ask_Stoic  (2026-07-12)

## Corpus Check
- 98 files · ~146,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 512 nodes · 623 edges · 54 communities (41 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19c48a08`
...
8. `/graphify` - 11 edges
9. `AppShell()` - 10 edges
10. `rejectUntrustedOrigin()` - 8 edges
...
Cohesion: 0.08
Nodes (24): AdminPage(), CommunityPage(), LessonPage(), CreatorPage(), EventsPage(), MasterPage(), MentorshipPage(), CommitmentPage() (+16 more)
...
Cohesion: 0.09
Nodes (22): CoursesPage(), DashboardPage(), FilterType, LearningPathData, LearningPathView(), LessonProgressItem, TierProgressItem, DashboardData (+14 more)
...
- **Why does `createClient()` connect `createClient` to `AskStoicScreens.tsx`, `EventsView.tsx`, `client.ts`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `getSupabaseConfig()` connect `client.ts` to `EventsView.tsx`, `createClient`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `requireActiveMembership()` connect `AskStoicScreens.tsx` to `server.ts`, `createClient`?**
