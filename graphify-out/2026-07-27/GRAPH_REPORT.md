...
## Corpus Check
- 183 files · ~192,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 847 nodes · 1392 edges · 75 communities (62 shown, 13 thin omitted)
...
- `CreatorEventsPage()` --calls--> `requireInfluencerWorkspace()`  [EXTRACTED]
  src/app/creator/events/page.tsx → src/lib/supabase/access.ts
...
Cohesion: 0.05
Nodes (47): AdminPage(), LessonPage(), LessonPageOptions, renderLessonPage(), CreatorAnalyticsPage(), CreatorLessonPage(), CreatorDashboardPage(), CreatorWorkspaceLayout() (+39 more)
...
Cohesion: 0.22
Nodes (8): Direction, Interaction and accessibility, Layout and components, Mobile, Palette, Stoicverse Design System, Surfaces, Typography
...
Cohesion: 0.12
Nodes (27): POST(), products, POST(), GET(), POST(), GET(), GET(), POST() (+19 more)
...
Cohesion: 0.08
Nodes (25): adminRoutes, authRoutes, config, copyResponseState(), creatorRoutes, isRouteMatch(), memberRoutes, proxy() (+17 more)
...
Cohesion: 0.09
Nodes (40): access(), creatorSupabase(), deleteCommunityStructure(), refresh(), reorderCommunityStructure(), Result, Role, roles() (+32 more)

### Community 58 - "courses/actions.ts"
Cohesion: 0.15
Nodes (27): ActionResult, addCourseVideo(), addLesson(), createCourse(), deleteCourse(), deleteCourseVideo(), driveId(), enrollInCourse() (+19 more)

### Community 59 - "CreatorOverviewView.tsx"
Cohesion: 0.14
Nodes (12): CreatorOverviewView(), currency, delta(), eventTime(), FilterOption, isSameDay(), number, OverviewData (+4 more)
...
Cohesion: 0.05
Nodes (51): DirectoryRow, Embedded, firstOf(), GET(), MemberRow, roleName(), SearchKind, SearchResult (+43 more)
...
## Knowledge Gaps
- **330 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+325 more)
...
- **Why does `createClient()` connect `AppShell.tsx` to `AskStoicScreens.tsx`, `client.ts`, `EventsView.tsx`, `createClient`, `courses/actions.ts`, `DashboardView.tsx`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `AppShell()` connect `DashboardView.tsx` to `AskStoicScreens.tsx`, `tiers/actions.ts`, `EventsView.tsx`, `createClient`, `LearningPathView.tsx`, `CommunitySurface.tsx`, `courses/actions.ts`, `CreatorOverviewView.tsx`?**
