# Graph Report - Ask_Stoic  (2026-07-10)

## Corpus Check
- 53 files · ~95,863 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 495 nodes · 480 edges · 39 communities (29 shown, 10 thin omitted)
...
3. `App Flow` - 15 edges
4. `Database Schema` - 15 edges
5. `Technical Requirements Document (TRD)` - 13 edges
6. `Implementation Plan` - 13 edges
7. `What You Must Do When Invoked` - 12 edges
8. `4. Core Features` - 12 edges
9. `/graphify` - 11 edges
10. `Product Requirements Document (PRD)` - 11 edges
...
Cohesion: 0.06
Nodes (18): AdminScreen(), AppShell(), AuthScreen(), ButtonLink(), CheckoutScreen(), CommitmentScreen(), CommunitySelectionScreen(), CreatorScreen() (+10 more)
...
Cohesion: 0.06
Nodes (35): 10. Notifications, 11. Stripe Webhook Log, 12. Database Functions & Triggers, 13. Summary of Tables, 1. Users & Auth, 2. Communities, 3. Memberships & Payments, 4. Channels & Posts (+27 more)
